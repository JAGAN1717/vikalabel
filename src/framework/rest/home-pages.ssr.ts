...
> = async ({ locale, params }) => {
  ...
  await queryClient.prefetchQuery(
    ...
    [API_ENDPOINTS.TYPES, { slug: 'clothing', language: locale }],
  ...
  await queryClient.prefetchInfiniteQuery(
    [
      ...
      { limit: PRODUCTS_PER_PAGE, type: 'clothing', language: locale },
    ],
  ...
  const categoryVariables = {
    ...
    parent:
      ...
      types.find((t) => t.slug === 'clothing')?.settings.layoutType === 'minimal'
        ? 'all'
        : 'null',
  };
  await queryClient.prefetchInfiniteQuery(
  ...
  return {
    props: {
      ...
      layout:
        ...
        types.find((t) => t.slug === 'clothing')?.settings.layoutType ??
        'default',
