  ...
  return (
    ...
    >
      ...
      <div className='bg-light shadow-sm'>
        <div className='border-b border-t border-border-200'>
        <div
          className={cn(
            ...
            'grid gap-4 grid-cols-3 w-full transform-gpu items-center justify-between text-light container mx-auto bg-light transition-transform duration-300 lg:h-22',
            {
      ...
      <div className='container mx-auto items-center hidden lg:block p-3 w-full'>
        <div className='flex justify-center w-full' >
          ...
          <div><small className='mb-0 mx-2 font-semibold text-slate-500 cursor-pointer hover:text-green-500'>HOME</small></div>
          <div><small className='mb-0 mx-2 font-semibold text-slate-500 cursor-pointer hover:text-green-500 '>NEW ARRIVALS</small></div>
